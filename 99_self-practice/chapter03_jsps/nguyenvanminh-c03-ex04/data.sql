DROP DATABASE IF EXISTS www_c03_ex04;
CREATE DATABASE www_c03_ex04 CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE www_c03_ex04;
...
VALUES ('Lập trình Java cơ bản', 'Nguyễn Văn A', 'java-core.png', 250000.00, 50),
       ...
       ('Python cho người mới bắt đầu', 'Võ Thị F', 'python.jpg', 270000.00, 0);
