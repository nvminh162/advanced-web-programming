...
import com.nvminh162.nguyenvanminh.dao.impl.QuanLyLoaiThuocImpl;
import com.nvminh162.nguyenvanminh.dao.impl.QuanLyThuocDAOImpl;
...
public class Run_DAO_Cau03 {
    public static void main(String[] args) {
        JPAUtil.init();

        QuanLyThuocDAO quanLyThuocDAO = new QuanLyThuocDAOImpl();
        QuanLyLoaiThuocDAO quanLyLoaiThuocDAO = new QuanLyLoaiThuocImpl();
